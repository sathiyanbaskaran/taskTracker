...
if(localStorage.getItem("progress") != null){
  resData = JSON.parse(localStorage.getItem("progress") || '{}');
...
function Progress() {
    ...
    const FilterByNameInput = (
      ...
      const statusUpdate = (key: any, e: any) => {
       console.log(key,e)
       key.completedDate = Date.now()
    var arrProgress = [];
    var existingProgressArr = []
    if(localStorage.getItem("done") != null){
      existingProgressArr = JSON.parse(localStorage.getItem("done") || '{}');
     ...
     localStorage.setItem("done",JSON.stringify(arrProgress));
       e.preventDefault();
      ...
      const columns = [
...

        {
          ...
          render: (text: any, record: any) => (
            <Button type="primary" className="start_btn start_btn_txt start_btn_txt_pad" onClick={(e) => statusUpdate(record, e)} >Completed</Button>
          ),
        },
        {
          title: 'Remove',
    ...
    return (
             ...
             <div>
               ...
               <Row>
                 ...
                 <Col span={16}>
                 <h3 className="text_decor">In Progress List</h3>
                 </Col>
                 <Col span={8}>
                 <Input
